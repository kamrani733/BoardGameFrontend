                          ...
                          {isMinor === 'true' ? (
                            ...
                            <>
                              ...
                              <div className="sign_box">
                                <ul>
                                  <li id="signin_tab" className={signIn} onClick={() => handleClick('signIn')}>
                                    <span>{translate({ lang: lang, info: 'sign_in' })}</span>
                                  </li>
                                  <li id="signup_tab" className={signUp} onClick={() => handleClick('signUp')}>
                                    <span>{translate({ lang: lang, info: 'sign_up' })}</span>
                                  </li>
                                </ul>
                                {visible === 'signIn' ? (
                                  <SignIn signSubmit={(e) => signSubmit(e)} lang={lang} socket={socket} />
                                ) : (
                              ...
                              <div className="sign_extra_info">
                                {visible === 'signIn' ? (
                                  <p onClick={() => handleForgotPassword()}>{translate({ lang: lang, info: 'signin_forgot_password' })}</p>
                                ) : (
                                  <>
                                    <div className="checkbox_radio_container">
                                      <label>
                                        <input
                                          ...
                                          name="checkbox1"
                                          checked={checkboxOne}
                                          onChange={() => handleChangeCheck('checkbox1')}
                                        />
                                        <h6>
